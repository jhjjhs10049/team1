...
const LocationPicker = ({
    ...
    const moveToCurrentLocation = () => {
        console.log('moveToCurrentLocation 함수 시작');
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                console.log('moveToCurrentLocation 함수 완료 - 자동 등록하지 않음');
            },
            (error) => {
                console.error('현재 위치를 가져올 수 없습니다:', error);
        ...
        console.log('moveToCurrentLocation navigator.geolocation.getCurrentPosition 호출 완료');
    };

    // 위치 확정
    const handleConfirmLocation = () => {
        console.log('handleConfirmLocation 함수 호출됨');
        ...
        if (markerRef.current) {
            ...
            console.log('위치 확정:', location);
            onLocationSelect(location);
            onClose();
        } else {
            console.error('마커가 초기화되지 않았습니다');
        }
    };
