...
const GymPurchasePage = () => {
    const { gymno } = useParams(); // 지금은 /gyms/1/purchase로만 들어오지만, 구조는 그대로
    ...
    return (
        <BasicLayout>
            <div style={styles.container}>
                ...
                {/* 트레이너 선택 */}
                <section style={styles.section}>
                    <label htmlFor="trainer" style={styles.label}>트레이너 선택</label>
                    <select
                        id="trainer"
                        value={trainerId}
                ...
                {/* 시간 선택 */}
                <section style={styles.section}>
                    <label htmlFor="time" style={styles.label}>시간 선택</label>
                    <select
                        id="time"
                        value={time}
                ...
                <section style={styles.sectionRow}>
                    <div style={{ flex: 1 }}>
                        <label htmlFor="count" style={styles.label}>횟수</label>
                        <input
                            id="count"
                            type="number"
                            min={1}
